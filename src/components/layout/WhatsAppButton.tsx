...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Desktop: Con texto */}
      <div className="hidden sm:flex items-center gap-3 bg-[#25D366] hover:bg-[#128C7E] text-white px-5 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
